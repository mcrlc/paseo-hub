/* oxlint-disable */
// Usage: QA_PG=postgres://qa:qa@127.0.0.1:55452/hub SPRITES_TOKEN_FILE=<dir>/token.json \
//   API_KEY_FILE=<dir>/api-key npx tsx docs/qa/ac-52w/seed-hub.ts
// Like ac-vni/s4-seed-hub.ts but with NO entitlement override: prints the effective canUseSpriteTargets,
// stores the Sprites org token, and mints a key for trigger install and manual runs. Secrets go only to chmod-600 files.
